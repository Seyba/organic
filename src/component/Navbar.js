                ...
                <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setOpen}>
                    ...
                    <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                            ...
                            >
                                <Dialog.Panel className="relative transform overflow-hidden rounded-sm bg-white shadow-xl transition-all md:w-3/6 w-full">
                                    ...
                                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                       <div className="block md:flex md:justify-between mb-4">
                                            ...
                                            <div className="flex items-center md:mt-0 mt-2">
                                                <div className="">
                                                    <h4 className="border border-green-900 border-1 px-8 bg-zinc-100  p-4 bg-gray-50">2</h4>
                                                </div>
                                                
                                                <div className="ml-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#950000" className="w-4 h-4">
                                        ...
                                        <div className="block md:flex md:justify-between mb-2">
                                            <div className="flex">
                                                <div className="mr-4">
                                                    <img src="/images/yellowpepper.png" className="h-16" alt="pepper"/>
                                                </div>
                                                <div className="">
                                                    <h4 className="text-xl font-semibold text-green-900">Yellow Pepper </h4>
                                                    <h6 className="text-lg font-semibold">$ 5.00 USD</h6>
                                                </div>
                                            </div>
                                            <div className="flex items-center md:mt-0 mt-2">
                                                <div className="">
                        ...
                        <div className="flex justify-between h-16 items-center">
                            ...
                            <div className="flow-root hidden lg:block">
                                <button className="navbar-cart-btn border border-1 rounded-3xl py-1 px-4">
                                    <Link onClick={() => setCartOpen(true)} className="group -m-2 flex justify-between items-center p-2">
                                        ...
                                        <div className="ml-2">
                                            <h2 className="navbar-cart leading-9 font-bold">Cart 4</h2>
                                        </div>
                                    </Link>
                                </button>
                            </div>
