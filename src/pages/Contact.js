...
export const Contact = () => {
  return (
    <>
      ...
      {/* <section className="">
        <div className="relative flex justify-center isolate overflow-hidden py-96 ">
          ...
          <div className="border border-green-700 p-8 border-t-8 w-5/6 md:w-4/6  bg-white md:bottom-24 bottom-4 absolute ">
            <form className="">
