                    ...
                    <div className="bg-white p-4 flex justify-center">
                        <div>
                            <div className="flex justify-between">
                                <div className="bg-green-950 rounded-xl px-3 ">
                                    <Link to="/">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#ffffff" className="w-7 h-7">
                            ...
                            <h4 >Whole Chicken</h4>
                            <button className="bg-green-950 text-white mx-auto rounded-xl w-3/4">$8</button>
                        </div>
                    </div>
