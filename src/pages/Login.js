        ...
        <section className="relative isolate overflow-hidden bg-zinc-900 px-4 md:px-0 py-24 sm:py-32">
            ...
            <div className="flex">
                <form className="py-10 px-4 mx-auto w-96 bg-white border border-zinc-300">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 my-4 divide-x">
                        <div className=" flex justify-center my-2">
                            <Link className="font-semibold sm:font-medium ">Forgot My Username</Link>
                            {/* <Link className="tracking-tight border-0 sm:items-left items-center sm:border-r border-gray-900 md:pr-8 pr-2 py-2">Forgot My Username</Link> */}
                        </div>
                        <div className="flex justify-center my-2">
